...
<html>
<head>
<title>Tattoo a Fashion Category Flat Bootstrap Responsive Website Template | Mail :: w3layouts</title>
<!-- for-mobile-apps -->
			...
			<nav class="navbar navbar-default">
				...
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo">
						<a class="navbar-brand animated wow wobble" data-wow-duration="1000ms" data-wow-delay="500ms" href="index.html"><span>T</span>attoo</a>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="mail-bottom">
				<div class="col-md-4 mail-bottom-left animated wow fadeInLeftBig" data-wow-duration="1000ms" data-wow-delay="500ms">
					...
					<h4>Address</h4>
					<p>1234 Avenue, 2K Street,4th Cross Building, London.</p>
				</div>
				<div class="col-md-4 mail-bottom-left animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
					...
					<p><a href="mailto:info@example.com">info@example2.com</a></p>
				</div>
			...
			<div class="container">
				...
				<div class="col-md-3 footer-grid">
					...
					<ul class="foot">
						...
						<li><a href="index.html">Featured Services</a></li>
